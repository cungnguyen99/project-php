      ...
      <table class="table table-striped b-t b-light">
        ...
        @foreach($allGenres as $items => $item)
          <tr>
            ...
            <td>
              <a href="{{URL::to('/edit-genre-film/'.$item->ID)}}" class="active" ui-toggle-class=""><i class="fa fa-pencil-square-o text-success text-active"></i></a> 
              <a onclick="return confirm('Bạn có muốn xóa không.')" href="{{URL::to('/delete-genre-film/'.$item->ID)}}" class="active" ui-toggle-class=""><i class="fa fa-times text-danger text"></i></a>
            </td>
          </tr>
        @endforeach
        </tbody>
