                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-6">
                                            ...
                                            <div class="form-group"><input class="form-control" type="text" name="theloai" placeholder="Thể loại *" value="{{$item->MaTheLoai}}" /></div>
                                            <div class="form-group"><input class="form-control" type="text" name="hangsx" placeholder="Hãng sản xuất *" value="{{$item->MaHSX}}" /></div>
