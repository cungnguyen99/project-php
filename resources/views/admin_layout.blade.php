    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu extended logout">
				...
				<!-- click vào logout sẽ gửi get logout vào route có get logout rồi từ route vào controller thực hiện hàm logout -->
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
				...
				<li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{URL::to('/add-showtime')}}">Thêm lịch chiếu</a></li>
						<li><a href="{{URL::to('/all-showtimes')}}">Liệt kê lịch chiếu</a></li>
                    </ul>
                </li>
								<li class="sub-menu">
                    <a href="javascript:;">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{URL::to('/manager-users')}}">User</a></li>
                    </ul>
                </li>
